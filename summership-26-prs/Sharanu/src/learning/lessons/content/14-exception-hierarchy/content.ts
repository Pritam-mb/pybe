...
That's the actual discipline behind ordering except blocks. It's not a style preference — a general except Exception placed too early doesn't just look sloppy, it actively steals cases away from the specific handler beneath it that was built to respond to them precisely, the same way a general response can't do what Shikhandi's very specific presence was needed to do. Specific first, general last, exactly mirrors specific commander first, general army structure catching whatever's left.`,
