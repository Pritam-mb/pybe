...
He sees an infant on a single leaf — the child form of Vishnu. As he watches, the infant breathes in, pulling him inside.

Inside, he finds an entire universe. He is breathed back out — facing the very same infant again.`,
  storyDialogue: [
  ...
  mappingExplainer: `What makes Markandeya's situation strange isn't the universe inside the universe — that part is wondrous. It's that the pattern has no natural point where it stops. The boon Vishnu eventually grants is, structurally, exactly what a base case is: a condition that says "here, this stops."
...
print(sum_down_to_zero(5))`,
    ...
    {
      stage: "apply",
      prompt: "A comment section lets replies nest inside replies indefinitely, and a function recursively renders each reply's children. What real-world data could cause a RecursionError here, and how would you defend against it besides just \"add a base case\"?",
    },
  ],
